...
const Notification = ({
  ...
  return toast.custom(
    t => (
      <div
        className={`relative flex max-w-sm transform-gpu flex-row items-start justify-between space-x-2 rounded-xl bg-base-200 p-4 shadow-center shadow-accent transition-all duration-500 ease-in-out ${
